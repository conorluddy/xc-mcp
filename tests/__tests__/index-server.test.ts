...
jest.mock('../../src/tools/xcodebuild/build.js', () => ({
  xcodebuildBuildTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'build result' }] })
}));

jest.mock('../../src/tools/xcodebuild/clean.js', () => ({
  xcodebuildCleanTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'clean result' }] })
}));

jest.mock('../../src/tools/xcodebuild/list.js', () => ({
  xcodebuildListTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'list result' }] })
}));

jest.mock('../../src/tools/xcodebuild/showsdks.js', () => ({
  xcodebuildShowSDKsTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'sdks result' }] })
}));

jest.mock('../../src/tools/xcodebuild/version.js', () => ({
  xcodebuildVersionTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'version result' }] })
}));

jest.mock('../../src/tools/xcodebuild/get-details.js', () => ({
  xcodebuildGetDetailsTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'details result' }] })
}));

jest.mock('../../src/tools/simctl/list.js', () => ({
  simctlListTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'simctl list result' }] })
}));
...
jest.mock('../../src/tools/simctl/shutdown.js', () => ({
  simctlShutdownTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'shutdown result' }] })
}));

jest.mock('../../src/tools/simctl/get-details.js', () => ({
  simctlGetDetailsTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'simctl details result' }] })
}));

jest.mock('../../src/tools/cache/cache-management.js', () => ({
  cacheGetStatsTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'stats result' }] }),
  cacheSetConfigTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'config set result' }] }),
  cacheGetConfigTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'config get result' }] }),
  cacheClearTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'clear result' }] })
}));

jest.mock('../../src/tools/cache/list-cached.js', () => ({
  listCachedResponsesTool: jest.fn().mockResolvedValue({ content: [{ type: 'text', text: 'cached list result' }] })
}));
